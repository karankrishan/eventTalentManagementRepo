...
public class Layout {
	...
	private Window createAccordionWindow() {
		...
		w.setHeadingText("Accordion Window");
		w.setWidth(200);
		w.setHeight(350);
	...
	private Window createBogusWindow(int index) {
		...
		w.setMinimizable(true);
		w.setMaximizable(true);
		w.setHeadingText("Bogus Window " + ++index);
		w.setSize(400, 300);
		return w;
	}
